...
import com.microsoft.appcenter.assets.testutils.FileAndroidTestUtils;
...
public class FileFinalizeAndroidTests {
    ...
    /**
     * Read file should throw a {@link AssetsFinalizeException}
    ...
    /**
     * Copy files should throw a {@link AssetsFinalizeException}
     * if an {@link IOException} is thrown during {@link FileUtils#finalizeResources(List, String)}.
     */
    @Test(expected = AssetsFinalizeException.class)
    ...
    /**
     * Write to file should throw a {@link AssetsFinalizeException}
     * if an {@link IOException} is thrown during {@link FileUtils#finalizeResources(List, String)}.
     */
    @Test(expected = AssetsFinalizeException.class)
    ...
    /**
     * Unzip files should throw a {@link AssetsFinalizeException}
     * if an {@link IOException} is thrown during {@link FileUtils#finalizeResources(List, String)}.
     */
    @Test(expected = AssetsFinalizeException.class)
