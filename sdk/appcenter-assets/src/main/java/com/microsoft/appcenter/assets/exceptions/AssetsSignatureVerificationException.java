 ...
 */
public class AssetsSignatureVerificationException extends SignatureException {
     ...
     */
    public AssetsSignatureVerificationException(SignatureExceptionType type) {
     ...
     */
    public AssetsSignatureVerificationException(Throwable cause) {
     ...
     * @param cause cause of exception.
     */
    public AssetsSignatureVerificationException(SignatureExceptionType type, Throwable cause) {
