...
public class AssetsUtils {
    ...
    /**
     * Gets and instance of {@link AssetsUtils}.
     *
     * @param fileUtils instance of {@link FileUtils} to work with.
     * @return instance of the class.
     */
    public static AssetsUtils getInstance(FileUtils fileUtils) {
        if (INSTANCE == null) {
    ...
    public String getStringFromInputStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            IOException e = mFileUtils.finalizeResources(
                    ...
                    null);
            if (e != null) {
                throw new AssetsFinalizeException(e);
            }
        }
    }
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public JSONObject getJsonObjectFromFile(String filePath) throws AssetsMalformedDataException {
        try {
            String content = mFileUtils.readFileToString(filePath);
            return new JSONObject(content);
        } catch (JSONException | IOException e) {
            throw new AssetsMalformedDataException(
     ...
     * @throws AssetsMalformedDataException exception during parsing data.
     */
    public <T> T getObjectFromJsonFile(String filePath, Class<T> classOfT) throws AssetsMalformedDataException {
    ...
    /**
     * Converts object to query string using the following scheme:
     * <ul>
     ...
     * @throws AssetsMalformedDataException error thrown when actual data is broken (i .e. different from the expected).
     */
    public String getQueryStringFromObject(Object object, String charsetName) throws AssetsMalformedDataException {
