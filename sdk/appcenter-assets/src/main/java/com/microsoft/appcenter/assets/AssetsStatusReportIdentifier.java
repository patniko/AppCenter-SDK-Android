 ...
 * Basically it is used in {@link AssetsTelemetryManager}
 ...
 */
public class AssetsStatusReportIdentifier {
    ...
    /**
     * Creates an instance of {@link AssetsStatusReportIdentifier}.
     *
     * @param versionLabel version label.
     */
    public AssetsStatusReportIdentifier(@NonNull String versionLabel) {
     ...
     * @param versionLabel  version label.
     */
    public AssetsStatusReportIdentifier(@NonNull String deploymentKey, @NonNull String versionLabel) {
     ...
     * @return {@link AssetsStatusReportIdentifier} instance if it could be parsed, <code>null</code> otherwise.
     */
    public static AssetsStatusReportIdentifier fromString(@NonNull String stringIdentifier) {
        String[] parsedIdentifier = stringIdentifier.split(":");
        if (parsedIdentifier.length == 1) {
            String versionLabel = parsedIdentifier[0];
            return new AssetsStatusReportIdentifier(versionLabel);
        } else if (parsedIdentifier.length == 2) {
            String versionLabel = parsedIdentifier[0];
            String deploymentKey = parsedIdentifier[1];
            return new AssetsStatusReportIdentifier(versionLabel, deploymentKey);
        } else {
            return null; 
        }
    }
