 ...
 */
public class AssetsReportStatusException extends AssetsApiHttpRequestException {
     ...
     */
    public AssetsReportStatusException(Throwable cause, ReportType reportType) {
     ...
     * @param reportType type of the sent report.
     */
    public AssetsReportStatusException(String result, ReportType reportType) {
