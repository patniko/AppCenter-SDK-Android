...
public class AssetsUpdateRequest {
    ...
    /**
     * Creates an update request based on the current {@link AssetsLocalPackage}.
     *
     * @param deploymentKey   the deployment key you want to query for an update against.
     * @param assetsPackage currently installed local package.
     * @param clientUniqueId  id of the device.
     * @return instance of the {@link AssetsUpdateRequest}.
     */
    public static AssetsUpdateRequest createUpdateRequest(final String deploymentKey,
                                                            final AssetsLocalPackage assetsPackage, final String clientUniqueId) throws AssetsIllegalArgumentException {
        AssetsUpdateRequest assetsUpdateRequest = new AssetsUpdateRequest();
        assetsUpdateRequest.setAppVersion(assetsPackage.getAppVersion());
        assetsUpdateRequest.setDeploymentKey(deploymentKey);
        assetsUpdateRequest.setPackageHash(assetsPackage.getPackageHash());
        assetsUpdateRequest.setLabel(assetsPackage.getLabel());
        assetsUpdateRequest.setClientUniqueId(clientUniqueId);
